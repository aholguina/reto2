    ...
    $.ajax(
        {
            ...
            error: function (xhr, status) {
                ...
                window.location = "introducirDisfraz.html";
                console.log(xhr);
    ...
    $.ajax(
        {
            ...
            url: 'https://g7f24b339c6f755-dbretouno.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/costume/costume/' + _id,
            type: 'GET',
            dataType: 'json',
...
function consultarId(id) {
    ...
    $.ajax(
        {
            url:     "https://g7f24b339c6f755-dbretouno.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/costume/costume/"  + id,
            type:     'GET',
            dataType:    'json',
