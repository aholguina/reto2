function consultar() {
    ...
    $.ajax(
        {
            url: 'https://g7f24b339c6f755-dbretouno.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client',
            type: 'GET',
            dataType: 'json',
    ...
    $.ajax(
        {
            ...
            error: function (xhr, status) {
                ...
                window.location = "introducirCliente.html";
                console.log(xhr);
    ...
    $.ajax(
        {
            ...
            url: 'https://g7f24b339c6f755-dbretouno.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + _id,
            type: 'GET',
            dataType: 'json',
    ...
    $.ajax(
        {
            ...
            url: 'https://g7f24b339c6f755-dbretouno.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/' + id,
            type: 'GET',
            dataType: 'json',
